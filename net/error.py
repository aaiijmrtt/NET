...
class Error:
	...
	def backpropagate(self, outputvector):
		...
		return self.derivative(self.previousoutput.pop(), outputvector)
...
class MeanSquared(Error):
	...
	def __init__(self, inputs):
		...
		self.derivative = configure.functions['subtract']
...
class CrossEntropy(Error):
	...
	def __init__(self, inputs):
		...
		Error.__init__(self, inputs)
		self.function = lambda x: x
		self.derivative = configure.functions['vectorize'](lambda x, y: (1.0 - y) / (1.0 - x + CrossEntropy.epsilon) - y / (x + CrossEntropy.epsilon))
...
class NegativeLogLikelihood(Error):
	...
	def __init__(self, inputs):
		...
		Error.__init__(self, inputs)
		self.function = lambda x: x
		self.derivative = configure.functions['vectorize'](lambda x, y: - y / (x + NegativeLogLikelihood.epsilon))
...
class KullbackLeiblerDivergence(Error):
	...
	def __init__(self, inputs):
		...
		Error.__init__(self, inputs)
		self.function = lambda x: x
		self.derivative = configure.functions['vectorize'](lambda x, y: - y / (x + KullbackLeiblerDivergence.epsilon))
...
class CosineDistance(Error):
	...
	def backpropagate(self, outputvector):
		...
		inputnorm = configure.functions['sum'](configure.functions['square'](self.previousinput[-1]))
		outputnorm = configure.functions['sum'](configure.functions['square'](outputvector))
		direction = configure.functions['sum'](configure.functions['multiply'](self.previousinput[-1], outputvector))
		return configure.functions['divide'](configure.functions['subtract'](configure.functions['multiply'](direction, self.previousinput.pop()), configure.functions['multiply'](inputnorm, outputvector)), configure.functions['sqrt'](outputnorm) * configure.functions['sqrt'](inputnorm) ** 3)
